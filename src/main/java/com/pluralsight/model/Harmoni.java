...
public class Harmoni {
    ...
    private static int currentMembers = 3;
    ...
    public static void addGrade(int grade){
        switch (grade) {
            case 1:
                ...
                currentMembers = currentMembers + Constants.CHILD_FIRST_HARM;
                break;
            case 2:
                maxMembers = currentMembers + Constants.MAX_SECOND_GRADE;
                currentMembers = currentMembers + Constants.CHILD_SECOND_HARM;
                break;
            case 3:
                maxMembers = Constants.MAX;
                currentMembers = currentMembers + Constants.CHILD_THIRD_HARM;
                break;
            case 4:
                currentMembers = currentMembers + Constants.CHILD_FOURTH_HARM;
                break;
            case 5:
                currentMembers = currentMembers + Constants.CHILD_FIFTH_HARM;
                break;
            case 6:
                currentMembers = currentMembers + Constants.CHILD_SIXTH_HARM;
                break;
